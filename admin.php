...
<body>
    ...
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
            <td style="color:white"><h1 align="center"><marquee><i>Processus de traduction d&#39;un document en arabe vers le fran&#231;ais</i>  </marquee></h1></td></tr>
        <tr>
          <td align="center"><b><i><mark style="color:white;background-color:maroon";>Gestionnaire CTD</mark></i></b></td>
        </tr>
      </table>
    </div>
...
<!--    <input type="text" placeholder="search by book id"><button type="button">search</button>  -->
       <p style="text-align:center;color:yellow;font-weight:bold">Tous les documents </p>
   <div class="main">
           ...
           $data=mysqli_query($conn,"SELECT * FROM `book`");
	              while($row = mysqli_fetch_array($data))
	               {   
						...
						echo "<td>"; echo $row["number_of_state"]; echo "</td>"; 
						echo "<td>"; echo $row["current_state"]; echo "</td>";
                        echo "</tr>";
                    }
